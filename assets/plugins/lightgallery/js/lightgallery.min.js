    ...
    P = (function () {
      ...
      return (
        (w.prototype.generateSettings = function (e) {
          if (
            ((this.settings = t(t({}, I), e)), this.settings.isMobile && "function" == typeof this.settings.isMobile ? this.settings.isMobile() : k())
          ) {
        ...
        (w.prototype.openGallery = function (t, e) {
          ...
          if ((void 0 === t && (t = this.settings.index), !this.lgOpened)) {
            ...
            this.zoomFromOrigin &&
              e &&
              ((this.currentImageSize = T(e, this.outer, g + d, h && this.settings.videoMaxSize)),
        ...
        (w.prototype.setImgMarkup = function (t, e, i) {
          var s = this.galleryItems[i],
            ...
            g =
              ...
              (this.isFirstSlideWithZoomAnimation() ? this.getDummyImageContent(e, i, a) : L(i, t, a, o, r, l)) +
              "</picture>";
          e.prepend(g);
        }),
        ...
        (w.prototype.loadContent = function (t, i) {
          ...
          if (
            ...
            (l || p) && this.LGel.trigger(s, { index: t, src: h, html5Video: c, hasPoster: !!l }),
            ...
            if (!this.lgBusy) {
              ...
              if (
                ...
                var v = void 0,
                  y = void 0;
                r > 2
                  ? ((v = t - 1), (y = t + 1), ((0 === t && o === r - 1) || (t === r - 1 && 0 === o)) && ((y = 0), (v = r - 1)))
                  : ((v = 0), (y = 1)),
        ...
        (w.prototype.enableDrag = function () {
          ...
          this.settings.enableDrag &&
            ...
            x(window).on("mouseup.lg.global" + this.lgId, function (o) {
              if (t.lgOpened) {
                var r = x(o.target);
                n ? ((n = !1), t.touchEnd(i, e, o), t.LGel.trigger(p)) : t.isPosterElement(r) && t.LGel.trigger(u),
